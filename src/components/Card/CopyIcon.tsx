...
export const CopyIconClient = ({ text }: { text: string }) => {
  ...
  return (
    <span className="inline-flex h-4 w-4 cursor-pointer justify-center relative top-[3px] hover:bg-slate-100 hover:text-white  items-center  ml-1 rounded-sm" onClick={handleCopy}>
