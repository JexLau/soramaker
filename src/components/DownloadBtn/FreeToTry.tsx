...
export const FreeToTry = ({ className, text, href = 'https://openai.com/sora', isDownload }: FreeToTryProps) => {
  ...
  bg-[conic-gradient(from_var(--shimmer-angle),theme(colors.red.700)_0%,theme(colors.red.300)_10%,theme(colors.red.700)_20%)] 
  animate-[shimmer_2.5s_linear_infinite] 
  after:flex after:absolute after:bg-red-700 after:inset-[2px] after:rounded-[22px] after:content-[attr(aria-label)]
